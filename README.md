...
![VPC Dashboard](screenshots/01-vpc-dashboard.png)
...
![Create VPC](screenshots/02-create-vpc.png)
...
![Subnet Created](screenshots/05-subnet-created.png)
...
![Internet Gateway Created](screenshots/06-internet-gateway-created.png)
...
![Route Table Updated](screenshots/08-route-table-updated.png)
...
![Security Group Inbound Rules](screenshots/09-security-group-inbound-rules.png)
...
![VPC Summary](screenshots/10-vpc-summary.png)
